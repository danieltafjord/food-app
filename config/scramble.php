...
use App\Data\OpenApi\DataOperationExtension;
...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Public API for connecting AI agents, Home Assistant and scripts to your household. Create an API token under Settings → API tokens and send it as a bearer token. A token is pinned to one household; read-only tokens may only make GET requests.',
    ],
