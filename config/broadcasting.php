    ...
    */
    ...
    'connections' => [
        ...
        'reverb' => [
            ...
            // Broadcasts are sent inside the request that made the change, so a
            // slow or unreachable Reverb must never hold that response for long.
            'client_options' => [
                'connect_timeout' => 1,
                'timeout' => 2,
            ],
            // Where devices open their WebSocket, when it differs from the host
            // the server publishes to (e.g. a private network address).
            'public' => [
